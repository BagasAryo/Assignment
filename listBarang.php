...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            if($hasil -> num_rows>0){
                echo "<table class='table table-striped'><thead><tr><th scope='col'>ID</th><th scope='col'>Nama</th><th scope='col'>Harga</th><th scope='col'>Stok</th><th scope='col'>Keterangan</th><th scope='col'>Foto</th><th scope='col'>Edit</th><th scope='col'>Hapus</th></tr></thead><tbody>";
                while($row = $hasil -> fetch_assoc()){
                    ...
                    $teks .= "<td><a href='delBrg.php?id=".$row["id"]."'>Delete</a></td>";
                    $teks .= "</tr>";
                    echo $teks;
                }
                echo "</tbody></table>";
